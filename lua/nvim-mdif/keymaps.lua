...
local function init()
  ...
  utils.skey('n', configuration['toggle_diary_yesterday'], pane.toggle_diary_yesterday)
  utils.skey('n', configuration['toggle_diary_tomorrow'], pane.toggle_diary_tomorrow)
